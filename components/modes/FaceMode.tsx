    ...
    <section className="px-4 sm:px-6 pb-safe max-w-xl mx-auto fade-up">
      ...
      <div className="rounded-3xl bg-white p-5 shadow-md mb-4">
        ...
        <div
          ...
          className="relative rounded-2xl border-2 border-dashed border-[#E5E5E0] bg-[#F5F5F0] h-52 flex flex-col items-center justify-center cursor-pointer hover:border-[#00C805] hover:bg-[#F0FDF4] transition-all overflow-hidden"
        >
          {preview ? (
